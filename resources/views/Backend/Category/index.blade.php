    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div> Project Category Create </div>
            </div>
        </div>
    </div>
                          ...
                          @foreach($categories as $g)
                              <tr>
                                  ...
                                  <td class="d-flex">
                                      ...
                                      <form id="deleteCategory{{ $g->id }}" action="{{ route('projectCategories.destroy',$g->id) }}" method="post" class="mx-2  ">
                                          @csrf @method('DELETE')
                                      </form>
